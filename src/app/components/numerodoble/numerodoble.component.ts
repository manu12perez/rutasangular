...
export class NumerodobleComponent implements OnInit {
  //ESTA VARIABLE NO TIENE NADA QUE VER CON EL PARAM
  ...
  redirect(num: number): void {
    //NOS VAMOS A LLAMAR A NOSOTROS MISMOS ENVIANDO EN LA RUTA EL PARAMETRO 
    //DEL NUMERO RECIBIDO
  ...
  ngOnInit(): void {
    ...
    this._activeRoute.params.subscribe((parametros: Params) => {
      ...
      //EN ESTE EJEMPLO, EL PARAMETRO SERA OPCIONAL, POR LO QUE 
